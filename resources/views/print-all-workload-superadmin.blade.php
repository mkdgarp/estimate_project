                                ...
                                <tr>
                                    <td>
                                        ...
                                        <div class="mb-2"><input class="ms-4 me-2 " type="checkbox"
                                                {{ $user->professor_group == 1 ? 'checked' : '' }}>กลุ่มทั่วไป
                                            ๑๕
                                            ภาระงาน/สัปดาห์</div>

                                        <div class="mb-2"><input class="ms-4 me-2 " type="checkbox"
                                                {{ $user->professor_group == 2 ? 'checked' : '' }}>กลุ่มเน้นสอน
                                            ๒๐
                                            ภาระงาน/สัปดาห์</div>

                                        <div class="mb-2"><input class="ms-4 me-2 " type="checkbox"
                                                {{ $user->professor_group == 3 ? 'checked' : '' }}>กลุ่มเน้นวิจัย
                                            ๙
                                            ภาระงาน/สัปดาห์</div>

                                        <div class="mb-2"><input class="ms-4 me-2 " type="checkbox"
                                                {{ $user->professor_group == 4 ? 'checked' : '' }}>กลุ่มเน้นบริการวิชาการ
